...
public class SalesOrderToInvoice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            toolbar.setTitle("Sales Order to Invoice");
        }

        orderListArrayList = syncManager.getSalesOrderListBySalesStatus(2);
        ...
        tvSearchButoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 11) {
                    dialog = new ProgressDialog(SalesOrderToInvoice.this, ProgressDialog.THEME_TRADITIONAL);
                }else{
                    dialog = new ProgressDialog(SalesOrderToInvoice.this);
                }
                ...
                orderListArrayList = syncManager.getSalesOrderListByMerchantAndDate(merchantID,dateFrom,dateTo,2);

                loadRecyclerView(orderListArrayList,id);
                dialog.dismiss();
            }
        });
        loadRecyclerView(orderListArrayList,id);
    ...
    private void loadRecyclerView(ArrayList<OrderList> orderListArrayList,int id) {
    ...
    private void loadMerchant(final ArrayList<MerchantDetails> merchantArrayList) {
        ...
        spdMerchant=new SpinnerDialog(SalesOrderToInvoice.this,merchantList,"Select or Search Merchant",R.style.DialogAnimations_SmileWindow);
    ...
    private void loadSalesRep(final ArrayList<SalesRep> salesRepArrayList) {
        ...
        spdSalesRep=new SpinnerDialog(SalesOrderToInvoice.this,salesRepList,"Select or Search SalesRep",R.style.DialogAnimations_SmileWindow);
