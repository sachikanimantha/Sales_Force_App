...
public class ViewSalesrepStock extends AppCompatActivity implements Runnable{

    TextView tv_slsrep_name,tv_slsrep_cono,tv_slsrep_id,tv_dis_name,tv_dis_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_salesrep_stock);
        ...
        btn_viewstock_print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBluetoothAdapter == null) {
                    Toast.makeText(ViewSalesrepStock.this, "Bluetooth Adapter null", Toast.LENGTH_SHORT).show();
                } else {
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        ListPairedDevices();
                        Intent connectIntent = new Intent(ViewSalesrepStock.this, IRA_DeviceList.class);
    ...
    private void init() {
        ...
        tv_slsrep_name = (TextView)findViewById(R.id.tv_salesrep_name_stock);
        tv_slsrep_cono = (TextView)findViewById(R.id.tv_salesrep_cono_stock);
        tv_slsrep_id = (TextView)findViewById(R.id.tv_salesrep_id_stock);
        tv_dis_name = (TextView)findViewById(R.id.tv_dis_name_stock);
        tv_dis_address = (TextView)findViewById(R.id.tv_dis_address_stock);
        rv_viewStock = (RecyclerView)findViewById(R.id.rv_viewstock_items);
        btn_viewstock_print = (Button)findViewById(R.id.btn_print_viewstock);
        ...
        productListArrayList = (new SyncManager(getApplicationContext())).getProductList_Salesrep_FromSQLite();
...
//        }
        ...
        BILL = "\n\n"+sp[19]+"Salesrep Inventory"+sp[20]+"\n\n\n";
            ...
            case REQUEST_CONNECT_DEVICE:
                if (mResultCode == Activity.RESULT_OK) {
                    ...
                    if (mBluetoothDevice != null) {
                        ...
                        mBluetoothConnectProgressDialog = new ProgressDialog(ViewSalesrepStock.this);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            mBluetoothConnectProgressDialog.dismiss();
            Toast.makeText(ViewSalesrepStock.this, "DeviceConnected", Toast.LENGTH_SHORT).show();
