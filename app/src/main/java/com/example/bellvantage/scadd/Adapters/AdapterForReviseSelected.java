...
public class AdapterForReviseSelected extends RecyclerView.Adapter<AdapterForReviseSelected.MyViewHolder> {

    ArrayList<ReviseSalesOrderList> arrayList = new ArrayList<>();
    Context context;
    SOR__ListItemActivity_Selected sor__listItemActivity_selected;

    public AdapterForReviseSelected(ArrayList<ReviseSalesOrderList> arrayList, Context context) {
        this.arrayList = arrayList;
        this.context = context;
        this.sor__listItemActivity_selected = (SOR__ListItemActivity_Selected) context;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_for_revise_sales_order,parent,false);
        return new MyViewHolder(view, sor__listItemActivity_selected);
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.llItemDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sor__listItemActivity_selected.getQty(reviseSalesOrderList);
    ...
    public class MyViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        CheckBox cbProducts;
        SOR__ListItemActivity_Selected sor__listItemActivityselected;

        public MyViewHolder(View itemView,SOR__ListItemActivity_Selected sor__listItemActivity_selected) {
            super(itemView);
            ...
            this.sor__listItemActivityselected = sor__listItemActivity_selected;
        ...
        @Override
        public void onClick(View v) {
            sor__listItemActivityselected.prepare(v,getAdapterPosition());
